...
<table class="table_dark">
    ...
    <tr>
        <td><a href="${pageContext.request.contextPath}/drivers/cars">Display All My Cars</a></td>
    </tr>
    <tr>
        <td><a href="${pageContext.request.contextPath}/manufacturers">Display All Manufacturers</a>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        <td><a href="${pageContext.request.contextPath}/manufacturers/add">Create new
            Manufacturer</a></td>
    </tr>
    <tr>
